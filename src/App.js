...
const App = () => {
  ...
  const csvFiles = [
    ...
    "ICSI Diamond Credit Card", "Celesta Credit card", "Central Bank of India Titanium Credit Card", "Central Bank of India World Credit Card", "HDFC Bank Infinia Credit Card", "HSBC Premier Mastercard Credit Card", "IDBI Bank Euphoria World Credit Card", "Imperio Credit CardIndian", "Kotak Mahindra Bank Solaris Platinum Credit Card", "Mastercard Gold Credit Card", "Mastercard Gold Secured Credit Card", "Mastercard World Credit Card", "Myntra Kotak Mastercard Credit Card", "RBL Bank Blockbuster Credit Card", "RBL Bank Fun+ Credit Card", "RBL Bank Mocash Credit Card", "RBL Bank Shoprite Credit Card", "Signet Credit Card", "Standard Chartered Bank Emirates World credit card", "Standard Chartered Bank Super Value Titanium credit card", "Swiggy HDFC Bank Credit Card", "YES BANK ACE Credit Card", "YES BANK RESERVE Credit Card", "YES BANK SELECT Credit Card", "YES First Business Credit Card", "YES FIRST Preferred Credit Card", "YES Prosperity Business Credit Card", "YES Prosperity Cashback Credit Card", "YES Prosperity Cashback Plus Credit Card", "YES Prosperity Rewards Credit Card", "6E Rewards XL-IndiGo HDFC Bank Credit Card", "6E Rewards-IndiGo HDFC Bank Credit Card", "Business Moneyback Credit Card", "Business Regalia Credit Card", "HDFC Millennia Credit Card", "Maruti Suzuki NEXA HDFC Bank AllMiles Credit Card", "ICICI Bank Coral Contactless Credit Card", "ICICI Bank NRI Coral Credit Card", "ICICI Bank Platinum Chip Credit Card", "ICICI Bank Rubyx Credit Card", "ICICI Bank Sapphiro Credit Card", "ICICI Bank Titanium Credit Card", "ICICI Bank Unifare Credit Card", "ICICI Bank Unifare Mumbai Metro Credit Card", "FIRST SWYP Credit Card", "Mayura Mastercard Credit Card", "MasterCard FIRST Classic Credit Card", "MasterCard FIRST Select Credit Card", "MasterCard FIRST Millennia Credit Card", "Club Vistara IDFC FIRST Credit Card", "LIC Classic IDFC FIRST Credit Card", "LIC Select IDFC FIRST Credit Card", "Indusind Bank Crest Credit Card", "Indusind Bank Pinnacle Credit Card", "IndusInd Bank Pioneer Heritage Credit Card", "IndusInd Bank Pioneer Legacy Credit Card", "Platinum Aura Edge Credit Card", "Platinum Credit Card"
  ];
